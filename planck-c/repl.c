...
connection_data_arrived_return_t* socket_repl_data_arrived(char *data, int sock, void *state) {
...
accepted_connection_cb_return_t* accepted_socket_repl_connection(int sock, void* state) {
    ...
    accepted_connection_cb_return->state = repl;
...
int run_repl() {
    ...
    socket_accept_data_t socket_accept_data = {config.socket_repl_host,
                                               config.socket_repl_port,
